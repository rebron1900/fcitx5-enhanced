...
| 语音（可选） | [言犀 / bibi keyboard](https://github.com/BryceWG/bibi_keyboard) 或兼容 AIDL 服务 |
...
- [言犀/bibi keyboard](https://github.com/BryceWG/bibi_keyboard) — 语音识别服务
